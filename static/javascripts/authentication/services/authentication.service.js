/**
 * Authentication
 * @namespace wingrade.authentication.services
 */
(function () {
  'use strict';

  angular
    .module('wingrade.authentication.services')
  ...
  function Authentication($cookies, $http, Snackbar) {
     ...
     * @memberOf wingrade.authentication.services.Authentication
     */
    ...
    function logout() {
      ...
      function logoutErrorFn(data, status, headers, config) {
        Snackbar.error("Unable to logout gracefully");
      }
    }
    ...
    function register(email, password, username) {
      ...
      */
      function registerErrorFn(data, status, headers, config) {
        Snackbar.error("Unable to register the account.");
      }
    }
